    ...
    <?php
      ...
      <div class = "headerPanel">
			...
			<div class = "contentBody">
				<div class = "headContent"><p>Games</p></div>
				<div class = "content">
          <div class = "inContent"><a href = "gamesValve.php"><img src = "../img/Valve.png" width = "75%" height = "auto"><p>Valve</p></a></div>
					<div class = "inContent"><a href = "gamesUbisoft.php"><img src = "../img/Ubisoft.png" width = "75%" height = "auto"><p>Ubisoft</p></a></div>
					<div class = "inContent"><a href = "gamesEA.php"><img src = "../img/ea.png" width = "75%" height = "auto"><p>Electornic Arts</p></a></div>
				</div>
				<div class = "footer">
