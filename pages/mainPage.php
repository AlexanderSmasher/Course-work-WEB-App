	...
	<body>
		...
		<div class = "body">
			...
			<div class = "contentBody">
				<div class = "headContent"><p>Popular products</p></div>
				<div class = "content">
					<div class = "inContent"><img src = "../img/products/Win10Pro.png" width = "75%" height = "auto"><p>Windows 10 Pro</p></a></div>
					<div class = "inContent"><img src = "../img/products/Photoshop.png" width = "75%" height = "auto"><p>Adobe Photoshop</p></div>
					<div class = "inContent"><img src = "../img/products/Win10Home.png" width = "75%" height = "auto"><p>Windows 10 Home</p></div>
					<div class = "inContent"><img src = "../img/products/Office365.png" width = "75%" height = "auto"><p>MS Office 365</p></div>
				</div>
				<div class = "footer">
