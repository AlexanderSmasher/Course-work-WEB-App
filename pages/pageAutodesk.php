    ...
    <?php
      ...
      <div class = "headerPanel">
			...
			<div class = "contentBody">
				<div class = "headContent"><p>Autodesk products</p></div>
				<div class = "content">
          <div class = "inContent"><a href = "autodeskDesign.php"><img src = "../img/Projecting.png" width = "75%" height = "auto"><p>Animations and graphics</p></a></div>
					<div class = "inContent"><a href = "autodeskProjecting.php"><img src = "../img/Factory.png" width = "75%" height = "auto"><p>Architecture and projecting</p></a></div>
					<div class = "inContent"><a href = "autodeskIndustry.php"><img src = "../img/Drawing.png" width = "75%" height = "auto"><p>Development and industry</p></a></div>
				</div>
				<div class = "footer">
