    ...
    <?php
      ...
      <div class = "headerPanel">
			...
			<div class = "contentBody">
				<div class = "headContent"><p>Adobe products</p></div>
				<div class = "content">
          <div class = "inContent"><a href = "adobePictures.php"><img src = "../img/ADesign.png" width = "75%" height = "auto"><p>Image processing</p></a></div>
					<div class = "inContent"><a href = "adobeDesign.php"><img src = "../img/BDesign.png" width = "75%" height = "auto"><p>Design</p></a></div>
					<div class = "inContent"><a href = "adobeVideo.php"><img src = "../img/CDesign.png" width = "75%" height = "auto"><p>Video processing</p></a></div>
					<div class = "inContent"><a href = "adobeAudio.php"><img src = "../img/Audition.png" width = "75%" height = "auto"><p>Audio processing</p></a></div>
				</div>
				<div class = "footer">
